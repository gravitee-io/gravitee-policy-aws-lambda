...
public class AwsLambdaTestPolicy extends AwsLambdaPolicy {
    ...
    private static final String AWS_WIREMOCK_ENDPOINT = "http://localhost:8080";

    public AwsLambdaTestPolicy(AwsLambdaPolicyConfiguration configuration) {
        super(configuration);
    }
    ...
    protected AWSLambdaAsync initLambdaClient() {
        return AWSLambdaAsyncClientBuilder
            ...
            .withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration(AWS_WIREMOCK_ENDPOINT, this.configuration.getRegion()))
            .build();
    }
}
