...
class AwsLambdaPolicyClientConfigurationTest {
    ...
    @Test
    void shouldBuildEmptyOverrideConfigurationWhenNoTimeoutsSet() {
        AwsLambdaPolicyV3 policy = new AwsLambdaTestPolicy(createDefaultConfig());

        ClientOverrideConfiguration overrideConfig = policy.buildClientOverrideConfiguration();
    ...
    @Test
    void shouldBuildEmptyOverrideConfigurationWhenOnlyHttpTimeoutsSet() {
        var config = createDefaultConfig();
    ...
    void shouldSetConnectionTimeout() {
        ...
        NettyNioAsyncHttpClient.Builder httpClientBuilder = policy.buildHttpClient();
